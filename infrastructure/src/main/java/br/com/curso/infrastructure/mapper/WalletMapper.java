...
public class WalletMapper {
    ...
    public WalletEntity toWalletEntity(Wallet wallet) {
        UserEntity userEntity = this.userMapper.toUserEntity(wallet.getUser());
        TransactionPinEntity transactionPinEntity = this.transactionPinMapper.toTransactionPinEntity(wallet.getTransactionPin());
